...
const BASE_ENTRIES: SettingsSearchEntry[] = [
  ...
  { id: 'audio-mic-mute-button', section: 'advanced', label: 'Use microphone mute button for dictation', description: 'Mute then unmute the selected mic to toggle hands-free dictation', target: 'audio-mic-mute-button', keywords: ['windows', 'linux', 'pipewire', 'mute', 'microphone', 'handsfree', 'button'] },
